...
[ESPnet: End-to-End Speech Processing Toolkit](https://arxiv.org/abs/1804.00015) is a simple but state-of-the-art toolkit. As ESPnet is **end-to-end** speech-to-text library. You can train/recognize your own speech/text pairs more easily than [other toolkits]([ESPnet: End-to-End Speech Processing Toolkit](https://arxiv.org/abs/1804.00015) is a simple but state-of-the-art toolkit for speech recogntion.). This document provides how to add your own dataset in ESPnet in a very simple way. For practical example, we gonna add a brand new corpus [JSUT](https://sites.google.com/site/shinnosuketakamichi/publication/jsut) in this tutorial.
